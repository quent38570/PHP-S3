...
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GEORGIO','concert','Concert de GEORGIO à La Belle Electrique','test.jpg','La Belle Electrique','29/03/19',30,27.0);
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('KYO','concert','Concert de KYO au Summum-Alpexpo','test.jpg','Summum-Alpexpo','06/12/18',10,35.0);
...
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('JEFF PANACLOC','spectacle','JEFF PANACLOC contre-attaque','test.jpg','Summum-Alpexpo','03/05/19',30,43.0);
...
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GRENOBLE/GAP','sport','SYNERGLACE LIGUE MAGNUS','test.jpg','Patinoire Polesud','28/12/2018',20,8.0);
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GRENOBLE/GAP','sport','SYNERGLACE LIGUE MAGNUS','test.jpg','Patinoire Polesud','18/01/19',30,8.0);
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GRENOBLE/BORDEAUX','sport','SYNERGLACE LIGUE MAGNUS','test.jpg','Patinoire Polesud','02/01/18',10,8.0);
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GRENOBLE/MONTPELLIER','sport','Match comptant pour le TOP 14','test.jpg','Stade des alpes','22/12/2018',25,24.0);
INSERT INTO evenement (nomEvenement,type,libelle,image,lieu,moment,nbBillet,prix) VALUES ('GRENOBLE/AGEN','sport','Match comptant pour le challenge européen','test.jpg','Stade des alpes','07/12/2018',15,12.5);
